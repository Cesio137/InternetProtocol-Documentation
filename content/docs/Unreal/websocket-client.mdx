...
-   Append a header to handshake request
    <ImageZoom
        src="/img/client-side/websocket/appendheader.png"
        alt="WS client"
        width={163}
        height={164}
    />
...
-   Clear all handshake headers
    <ImageZoom
        src="/img/client-side/websocket/clearheaders.png"
        alt="WS client"
        width={163}
        height={104}
    />
...
-   Remove specific header from handshake
    <ImageZoom
        src="/img/client-side/websocket/removeheader.png"
        alt="WS client"
        width={163}
        height={134}
    />
...
-   Remove specific header from handshake
    <ImageZoom
        src="/img/client-side/websocket/getheader.png"
        alt="WS client"
        width={201}
        height={60}
    />
